...
def main():
    ...
    l=['ideal_l','ideal_h','butterworth_l','butterworth_h','gaussian_h','gaussian_l']
    #print l
    ...
    display_image=(image_name+"_"+mask,output[0])
    display_image=(image_name+"_dft_"+mask,output[1])
    display_image=(image_name+"_dft_filter_"+mask,output[2])
